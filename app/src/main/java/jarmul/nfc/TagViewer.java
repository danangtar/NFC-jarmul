...
import jarmul.nfc.record.ParsedNdefRecord;
...
public class TagViewer extends AppCompatActivity {
    ...
    private String dumpTagData(Parcelable p) {
        ...
        idd.append(getDec(id));
        String aidi;
        aidi = idd.toString();
        if(aidi.equals("36078996631415044")) {
            sb.append("KTP Danang").append("\n");
        }

        Intent wewew = new Intent(TagViewer.this, MainActivity.class);
        wewew.putExtra("ID", aidi);
        startActivity(wewew);



        sb.append("String: ").append(id.toString()).append("\n");
